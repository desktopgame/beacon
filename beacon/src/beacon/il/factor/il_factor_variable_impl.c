...
// proto
static void ILVariable_check(bc_ILVariable* self, bc_Enviroment* env,
                             bc_CallContext* cctx);
static void ILVariable_check_instance(bc_ILVariable* self, bc_Enviroment* env,
                                      bc_CallContext* cctx);
static void ILVariable_check_static(bc_ILVariable* self, bc_Enviroment* env,
                                    bc_CallContext* cctx);
...
bc_ILVariable* bc_MallocILVariable(const char* filename, int lineno) {
        bc_ILVariable* ret = (bc_ILVariable*)bc_MXMalloc(sizeof(bc_ILVariable),
                                                         filename, lineno);
...
static void ILVariable_check_instance(bc_ILVariable* self, bc_Enviroment* env,
        ...
        if (ctype != NULL) {
                ...
                bc_ILVariableLocal* lc =
                    bc_NewILVariableLocal(self->FQCN->Name);

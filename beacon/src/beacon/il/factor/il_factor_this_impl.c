...
static void check_context(bc_ILThis* self, bc_Enviroment* env,
                          bc_CallContext* cctx);
...
void bc_GenerateILThis(bc_ILThis* self, bc_Enviroment* env,
                       bc_CallContext* cctx) {
...
void bc_DeleteILThis(bc_ILThis* self) { MEM_FREE(self); }
// private
static void check_context(bc_ILThis* self, bc_Enviroment* env,
                          bc_CallContext* cctx) {

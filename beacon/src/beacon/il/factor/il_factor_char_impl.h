 ...
 * @param cache
 */
void il_factor_char_generate(il_factor_char* self, struct enviroment* env, il_load_cache* cache);
 ...
 * @param eh
 */
void il_factor_char_load(il_factor_char* self, struct enviroment* env, il_load_cache* cache, il_ehandler* eh);

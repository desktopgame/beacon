...
struct generic_type* il_factor_excor_op_eval(il_factor_excor_op * self, struct enviroment * env);

void il_factor_excor_op_generate(il_factor_excor_op* self, struct enviroment* env);

void il_factor_excor_op_load(il_factor_excor_op* self, struct enviroment* env);

...
static void ILNewInstance_find(bc_ILNewInstance * self, bc_Enviroment * env, bc_CallContext* cctx);
...
bc_ILNewInstance * bc_NewILNewInstance() {
	bc_ILNewInstance* ret = (bc_ILNewInstance*)MEM_MALLOC(sizeof(bc_ILNewInstance));

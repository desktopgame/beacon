...
void il_factor_dec_generate(il_factor_dec* self, struct enviroment* env, call_context* cctx);

void il_factor_dec_load(il_factor_dec* self, struct enviroment* env, call_context* cctx);

generic_type* il_factor_dec_eval(il_factor_dec* self, struct enviroment* env, call_context* cctx);

char* il_factor_dec_tostr(il_factor_dec* self, struct enviroment* env);

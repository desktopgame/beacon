...
void il_factor_explicit_unary_op_generate(il_factor_explicit_unary_op* self, struct enviroment* env);

void il_factor_explicit_unary_op_load(il_factor_explicit_unary_op* self, struct enviroment* env);

struct generic_type* il_factor_explicit_unary_op_eval(il_factor_explicit_unary_op* self, struct enviroment* env);

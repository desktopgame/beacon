...
void il_factor_inc_generate(il_factor_inc* self, struct enviroment* env, call_context* cctx);

void il_factor_inc_load(il_factor_inc* self, struct enviroment* env, call_context* cctx);

generic_type* il_factor_inc_eval(il_factor_inc* self, struct enviroment* env, call_context* cctx);

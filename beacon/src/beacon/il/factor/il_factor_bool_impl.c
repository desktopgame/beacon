...
void il_factor_bool_generate(il_factor_bool * self, enviroment * env, il_context* cache) {
	if (self->a) {
...
generic_type* il_factor_bool_eval(il_factor_bool * self, enviroment * env, il_context* cache) {

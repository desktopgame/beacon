...
static void resolve_non_default(bc_ILInvokeBound* self, bc_Enviroment* env,
                                bc_CallContext* cctx);
static void resolve_default(bc_ILInvokeBound* self, bc_Enviroment* env,
                            bc_CallContext* cctx);
...
static void GenerateILInvokeBound_method(bc_ILInvokeBound* self,
                                         bc_Enviroment* env,
                                         bc_CallContext* cctx);
static void GenerateILInvokeBound_subscript(bc_ILInvokeBound* self,
                                            bc_Enviroment* env,
                                            bc_CallContext* cctx);
static bc_GenericType* ILInvokeBound_return_gtype(bc_ILInvokeBound* self,
                                                  bc_CallContext* cctx);
static bc_GenericType* EvalILInvokeBoundImpl(bc_ILInvokeBound* self,
                                             bc_Enviroment* env,
                                             bc_CallContext* cctx);

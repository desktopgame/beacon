...
void il_stmt_variable_init_generate(il_stmt_variable_init * self, enviroment * env, il_context* cache) {
...
void il_stmt_variable_init_load(il_stmt_variable_init * self, enviroment * env, il_context* cache, il_ehandler * eh) {

 ...
 * @param cache
 */
void il_stmt_variable_decl_generate(il_stmt_variable_decl* self, struct enviroment* env, il_context* cache);
 ...
 * @param eh
 */
void il_stmt_variable_decl_load(il_stmt_variable_decl* self, struct enviroment* env, il_context* cache, il_ehandler* eh);

...
void il_stmt_continue_generate(void* empty, struct enviroment* env, il_context* cache);

void il_stmt_continue_load(void* empty, struct enviroment* env, il_context* cache, il_ehandler* eh);

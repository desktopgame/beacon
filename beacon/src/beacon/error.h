...
/**
 * @file error.h
 * @brief beaconインタプリタのパニック情報を定義します。
 * @author koya
 * @date 2018/10/31
 */
...
#define BC_ERROR() if(bc_GetLastPanic()) return
#define BC_ERROR_RET(a) if(bc_GetLastPanic()) return a
/**
 * beaconインタプリタがソース解析中に検出したパニックを表す列挙.
 */

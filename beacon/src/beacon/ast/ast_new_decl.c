...
static bc_AST* NewASTClassDeclImpl(bc_AST* aclass_name, bc_AST* aextend_list,
                                   bc_AST* amember_list, bc_ASTTag tag);
...
bc_AST* bc_NewASTNamespaceNamespaceDecl(bc_AST* anamespace_path,
                                        bc_AST* abody) {
...
bc_AST* bc_NewASTAbstractClassDecl(bc_AST* aclass_name, bc_AST* aextend_list,
                                   bc_AST* amember_list) {
        return NewASTClassDeclImpl(aclass_name, aextend_list, amember_list,
...
bc_AST* bc_NewASTFunctionDeclEmptyParams(bc_StringView function_name,
                                         ...
                                         bc_AST* areturn_type) {
        return bc_NewASTFunctionDecl(function_name, atypeparams,
                                     bc_NewASTBlank(), abody, areturn_type);
}
...
bc_AST* bc_NewASTMethodDeclEmptyParams(bc_AST* amodifier,
                                       ...
                                       bc_AST* areturn_type) {
        return bc_NewASTMethodDecl(amodifier, func_name, atype_parameter,
                                   bc_NewASTBlank(), abody, areturn_type);
}

 ...
 * time: 2018-08-17
 */
static void bc_system_nativeExit(bc_Method* parent, bc_Frame* fr,
                                 bc_Enviroment* env);
...
void bc_InitSystem() {
        ...
        bc_DefineNativeMethodClass(systemClass, "nativeExit",
                                   bc_system_nativeExit);
        bc_DefineNativeMethodClass(systemClass, "nativeAbort",
                                   bc_system_nativeAbort);
        bc_DefineNativeMethodClass(systemClass, "nativeExec",
                                   bc_system_nativeExec);
}

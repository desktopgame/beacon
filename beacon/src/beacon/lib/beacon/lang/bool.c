...
static void bc_bool_nativeBitOr(bc_Method* parent, bc_Frame* fr,
                                bc_Enviroment* env);
...
void bc_InitBool() {
        ...
        bc_DefineNativeMethodClass(boolClass, "nativeBitOr",
                                   bc_bool_nativeBitOr);
        bc_DefineNativeMethodClass(boolClass, "nativeBitAnd",
...
static void bc_bool_nativeBitOr(bc_Method* parent, bc_Frame* fr,
        ...
        bc_Object* ret =
            bc_GetBoolObject(bc_ObjectToBool(self) | bc_ObjectToBool(a));

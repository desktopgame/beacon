...
void bc_InitLong() {
	...
	bc_DefineNativeMethodClass(longClass, "nativeEquals", bc_long_nativeEquals);
	...
	bc_DefineNativeMethodClass(longClass, "nativeLShift", bc_long_nativeLShift);
	bc_DefineNativeMethodClass(longClass, "nativeRShift", bc_long_nativeRShift);
	...
	bc_DefineNativeMethodClass(longClass, "nativeBitOr", bc_long_nativeBitOr);
	bc_DefineNativeMethodClass(longClass, "nativeBitAnd", bc_long_nativeBitAnd);
...
static void bc_long_nativeInit(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
...
static void bc_long_nativeEquals(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* i = bc_AtVector(fr->VariableTable, 1);
	bc_PushVector(fr->ValueStack, bc_BoolToObject(bc_ObjectToLong(self) == bc_ObjectToLong(i)));
}

static void bc_long_nativeAdd(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) + LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
}

static void bc_long_nativeSub(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) - LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeMul(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) * LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeDiv(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) / LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeMod(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) % LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeLShift(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) << LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeRShift(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) >> LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeGT(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
...
static void bc_long_nativeGE(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = bc_GetBoolObject(LONG_VALUE(self) >= LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeLT(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = bc_GetBoolObject(LONG_VALUE(self) < LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeLE(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = bc_GetBoolObject(LONG_VALUE(self) <= LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeBitOr(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) | LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeBitAnd(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = (bc_Object*)bc_NewLong(LONG_VALUE(self) & LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);
...
static void bc_long_nativeEQ(bc_Method* parent, bc_Frame* fr, bc_Enviroment* env) {
	bc_Object* self = bc_AtVector(fr->VariableTable, 0);
	bc_Object* a = bc_AtVector(fr->VariableTable, 1);
	bc_Object* ret = bc_GetBoolObject(LONG_VALUE(self) == LONG_VALUE(a));
	bc_PushVector(fr->ValueStack, ret);

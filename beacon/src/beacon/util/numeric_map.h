 ...
 * @param item
 */
typedef void(*bc_NumericMapAction)(bc_NumericMapKey name, bc_NumericMapItem item);

/**
 * ツリーのデリータ関数です.
 * @param item
 */
typedef void(*bc_NumericMapDeleter)(bc_NumericMapKey name, bc_NumericMapItem item);

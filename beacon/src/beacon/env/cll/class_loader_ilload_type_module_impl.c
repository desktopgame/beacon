...
static void CLILTypeParameter_rule(struct bc_ClassLoader* self,
                                   struct bc_AST* asource, bc_Vector* dest);
static void ast_fqcn_flatten(bc_AST* afqcn, bc_Vector* dest);
static void CLILArgumentListImpl(bc_ClassLoader* self, bc_Vector* list,
                                 bc_AST* asource);
...
void CLILTypenameList(bc_ClassLoader* self, bc_Vector* dst,
...
void CLILTypeArgument(bc_ClassLoader* self, bc_AST* atype_args,
                      bc_Vector* dest) {
...
static void CLILTypeParameter_rule(bc_ClassLoader* self, bc_AST* asource,
                                   bc_Vector* dest) {
        assert(false);
        /*

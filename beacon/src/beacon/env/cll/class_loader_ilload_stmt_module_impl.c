...
static bc_ILInferencedTypeInit* CLIL_inferenced_type_init(bc_ClassLoader* self,
                                                          bc_AST* asource);
static bc_ILVariableDecl* CLIL_variable_decl(bc_ClassLoader* self,
                                             bc_AST* asource);
static bc_ILVariableInit* CLIL_variable_init(bc_ClassLoader* self,
                                             bc_AST* asource);
...
static void CLIL_elif_list(bc_ClassLoader* self, bc_Vector* list,
                           bc_AST* asource);
...
static void CLIL_catch_list(bc_ClassLoader* self, bc_Vector* dest,
                            bc_AST* asource);
...
static bc_ILYieldReturn* CLIL_yield_return(bc_ClassLoader* self,
                                           bc_AST* asource);
        ...
        switch (asource->Tag) {
                ...
                case AST_YIELD_RETURN_T: {
                        return bc_WrapILYieldReturn(
                            CLIL_yield_return(self, asource));
                }

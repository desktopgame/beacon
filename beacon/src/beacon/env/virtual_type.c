...
//proto
static bool virtual_type_comp(virtual_type* self, generic_type* a);
...
bool virtual_type_void(virtual_type* self) {
	return virtual_type_comp(self, CL_VOID->generic_self);
}

bool virtual_type_int(virtual_type* self) {
	return virtual_type_comp(self, CL_INT->generic_self);
}

bool virtual_type_double(virtual_type* self) {
	return virtual_type_comp(self, CL_DOUBLE->generic_self);
}

bool virtual_type_bool(virtual_type* self) {
	return virtual_type_comp(self, CL_BOOL->generic_self);
}

bool virtual_type_char(virtual_type* self) {
	return virtual_type_comp(self, CL_CHAR->generic_self);
}

bool virtual_type_null(virtual_type* self){
	return virtual_type_comp(self, CL_NULL->generic_self);
}

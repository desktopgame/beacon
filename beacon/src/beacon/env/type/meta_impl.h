...
/**
 * 仮引数と実引数のマッチ率を返します.
 * 一つでも継承関係のないパラメータ/アーギュメントの組みを見つけると -1
 * を返します. マッチ率が高ければ高いほど 0 に近い値を返します。
 * @param params
 * @param ilargs
 * @param env
 * @param cctx
...
bc_Constructor* bc_MetaRFindConstructor(bc_Vector* ctor_vec, bc_Vector* args,
                                        bc_Vector* typeargs,
                                        struct bc_Frame* fr, int* outIndex);
/**
...
bc_Constructor* bc_MetaScopedILFindConstructor(
    struct bc_Class* context, bc_Vector* ctor_vec, bc_Vector* ilargs,
 ...
 * @return
 */
bc_Constructor* bc_MetaScopedRFindConstructor(
    struct bc_Class* context, bc_Vector* ctor_vec, bc_Vector* gargs,
    bc_Vector* typeargs, struct bc_Frame* fr, int* outIndex);
 ...
 * @return
 */
bool bc_IsMetaConstructorAccessValid(struct bc_Constructor* ctor,
                                     bc_CallContext* cctx);

 ...
 * @return
 */
bool bc_IsImplementInterfaceMethodValidClass(struct bc_Class* cls, struct bc_Method** out);
/**
 ...
 * @return
 */
bool bc_IsImplementInterfacePropertyValidClass(struct bc_Class* cls, struct bc_Property** out);
 ...
 * @return
 */
bool bc_IsImplementAbstractClassValidClass(struct bc_Class* cls, struct bc_Method** out);

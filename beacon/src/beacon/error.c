...
char* bc_Vfpanic(BCErrorID id, va_list ap) {
        ...
        switch (id) {
                ...
                case BCERROR_EMPTY_STMT_METHOD_T:
                        fmt =
                            "must be not empty statement if modifier of method "
                            "is native or abstract: %s";
                        break;
                case BCERROR_NOT_EMPTY_STMT_METHOD_T:
                        fmt =
                            "must be empty statement if modifier of method is "
                            "native or abstract: %s";
                        break;

                case BCERROR_RETURN_VALUE_VOID_METHOD_T:
                        fmt =
                            "must be not return a value if return type of "
                            "Void: %s#%s";
                        break;
                case BCERROR_NOT_RETURN_VALUE_NOT_VOID_METHOD_T:
                        fmt =
                            "must be return a value if return type of not "
                            "Void: %s#%s";
                        break;
                case BCERROR_RETURN_VALUE_TYPE_IS_NOT_COMPATIBLE_NOT_VOID_METHOD_T:
                        fmt =
                            "return value is must be compatible to method "
                            "return type: %s#%s";
                        break;

                case BCERROR_YIELD_RETURN_VALUE_TYPE_IS_NOT_COMPATIBLE_T:
                        fmt =
                            "yield return value is must be compatible to "
                            "method return type: %s#%s";
                        break;
                ...
                case BCERROR_NOT_INITIAL_FIELD_NOT_INITIALIZED_AT_CTOR_T:
                        fmt =
                            "must be initialize a `final` attributed field: "
                            "%s#%s";
                        break;
                case BCERROR_FIELD_DEFAULT_VALUE_NOT_COMPATIBLE_TO_FIELD_TYPE_T:
                        fmt =
                            "field initializer result type is not compatible "
                            "to field type: %s#%s";
                        break;
                ...
                case BCERROR_ARG_COUNT_NOT2_BIOPERATOR_T:
                        fmt =
                            "illegal of parameter count, must be binary "
                            "operator argument count is one.: %s#%s";
                        break;
                case BCERROR_ARG_COUNT_NOT1_UOPERATOR_T:
                        fmt =
                            "illegal of parameter count, must be unary "
                            "operator argument count is zero.: %s#%s";
                        break;
                ...
                case BCERROR_RETURN_TYPE_NOT_BOOL_COMPARE_OPERATOR_T:
                        fmt =
                            "return type of `compare` operator is must be "
                            "bool: %s#%s";
                        break;
                case BCERROR_RETURN_TYPE_NOT_BOOL_NOT_OPERATOR_T:
                        fmt =
                            "return type of `not` operator is must be bool: "
                            "%s#%s";
                        break;
                case BCERROR_RETURN_TYPE_NOT_EQUAL_NEGATIVE_OPERATOR_T:
                        fmt =
                            "return type of `negative` operator is must be "
                            "equal from declared type: %s#%s";
                        break;

                case BCERROR_THROWN_NOT_EXCEPTION_TYPE_T:
                        fmt =
                            "must be thrown Object type compatible to "
                            "`exception`: %s";
                        break;

                case BCERROR_ASSIGN_NOT_COMPATIBLE_LOCAL_T:
                        fmt =
                            "assign expression is has not type compatible: %s";
                        break;
                case BCERROR_ASSIGN_NOT_COMPATIBLE_FIELD_T:
                        fmt =
                            "assign expression is has not type compatible: "
                            "%s#%s";
                        break;
                ...
                case BCERROR_AUTO_CHAIN_CTOR_NOT_FOUND_T:
                        fmt =
                            "need chain constructor if not found of super "
                            "class empty constructor: %s#new";
                        break;
                ...
                case BCERROR_CONSTRUCT_ABSTRACT_TYPE_T:
                        fmt =
                            "can't construct a abstract type by new operator: "
                            "%s";
                        break;
                ...
                case BCERROR_MULTI_EQINTERFACE_T:
                        fmt =
                            "should'nt implement equal interface a multiple: "
                            "%s";
                        break;
                ...
                case BCERROR_ABSTRACT_METHOD_BY_T:
                        fmt =
                            "abstract method should be defined on the abstract "
                            "class: %s";
                        break;
                ...
                case BCERROR_INVALID_PROPERTY_DECL_T:
                        fmt =
                            "can't use abbrev expression for only one Property "
                            "accessor: %s#%s";
                        break;
                ...
                case BCERROR_INVALID_ACCESS_LEVEL_OF_PROPERTY_T:
                        fmt =
                            ...
                            "level more than Property: %s#%s";
                        break;
                case BCERROR_SPECIFIED_BOTH_PROPERTY_ACCESSOR_T:
                        fmt =
                            "specified both access level of Property accessor: "
                            "%s#%s";
                        break;
                default: {
                        return bc_Strdup(
                            "if shown this message, it compiler bug\n");
                }
        }
...
void bc_SetPanicLine(int lineno) { gPanicLineNo = lineno; }

void bc_SetPanicColumn(int column) { gPanicColumn = column; }

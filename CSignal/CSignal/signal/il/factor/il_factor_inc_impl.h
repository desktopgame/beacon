...
void il_factor_inc_load(il_factor_inc* self, struct enviroment* env, il_ehandler* eh);

struct type* il_factor_inc_eval(il_factor_inc* self, struct enviroment* env);

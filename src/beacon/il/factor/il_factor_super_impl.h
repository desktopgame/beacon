...
void bc_GenerateILSuper(bc_ILSuper* self, struct bc_Enviroment* env,
                        bc_CallContext* cctx);

void bc_LoadILSuper(bc_ILSuper* self, struct bc_Enviroment* env,
                    bc_CallContext* cctx);

bc_GenericType* bc_EvalILSuper(bc_ILSuper* self, struct bc_Enviroment* env,
                               bc_CallContext* cctx);

...
struct bc_GenericType* bc_EvalILChildaOp(bc_ILChildaOp* self,
                                         struct bc_Enviroment* env,
                                         bc_CallContext* cctx);

void bc_GenerateILChildaOp(bc_ILChildaOp* self, struct bc_Enviroment* env,
                           bc_CallContext* cctx);

void bc_LoadILChildaOp(bc_ILChildaOp* self, struct bc_Enviroment* env,
                       bc_CallContext* cctx);

...
bc_GenericType* bc_EvalILNotOp(bc_ILNotOp* self, bc_Enviroment* env,
                               bc_CallContext* cctx) {
        return bc_TYPE2GENERIC(BC_TYPE_BOOL);
}

void bc_GenerateILNotOp(bc_ILNotOp* self, bc_Enviroment* env,
                        bc_CallContext* cctx) {
...
void bc_LoadILNotOp(bc_ILNotOp* self, bc_Enviroment* env,
                    bc_CallContext* cctx) {
...
void bc_DeleteILNotOp(bc_ILNotOp* self) { MEM_FREE(self); }

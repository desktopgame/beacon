...
void bc_GenerateILDouble(bc_ILDouble* self, bc_Enviroment* env,
                         bc_CallContext* cctx) {
...
void bc_LoadILDouble(bc_ILDouble* self, bc_Enviroment* env,
                     bc_CallContext* cctx) {}

bc_GenericType* bc_EvalILDouble(bc_ILDouble* self, bc_Enviroment* env,
                                bc_CallContext* cctx) {
...
void bc_DeleteILDouble(bc_ILDouble* self) { MEM_FREE(self); }
 ...
 * @return
 */
struct bc_ImportInfo* bc_ImportImportManager(bc_ImportManager* self,
                                             struct bc_ClassLoader* target);
 ...
 */
struct bc_GenericType* bc_ResolveImportManager(struct bc_Namespace* scope,
                                               struct bc_GenericCache* fqcn,
 ...
 * @return 解決出来なかったなら NULL を返します.
 */
struct bc_GenericType* bc_ResolvefImportManager(struct bc_Namespace* scope,

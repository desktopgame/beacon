...
bc_AST* bc_NewASTIfElifList(bc_AST* acond, bc_AST* atrueBody,
                            bc_AST* aelifList) {
...
bc_AST* bc_NewASTIfElifListElse(bc_AST* acond, bc_AST* atrueBody,
                                bc_AST* aelifList, bc_AST* aelseBody) {
...
bc_AST* bc_NewASTBreak() { return bc_NewAST(AST_BREAK_T); }

bc_AST* bc_NewASTContinue() { return bc_NewAST(AST_CONTINUE_T); }
...
bc_AST* bc_NewASTReturnEmpty() { return bc_NewAST(AST_RETURN_EMPTY_T); }
...
bc_AST* bc_MallocASTFQCNPart(bc_StringView namev, const char* filename,
                             int lineno) {
...
bc_AST* bc_NewASTVariableInit(bc_AST* atype, bc_StringView name,
                              bc_AST* afact) {
...
bc_AST* bc_NewASTYieldBreak() { return bc_NewAST(AST_YIELD_BREAK_T); }
